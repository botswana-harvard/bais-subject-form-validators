...
from ..form_validations import SexualHistoryAndBehaviourFormValidator
from ..constants import CONCURRENT


class TestSexualHistoryAndBehaviourFormValidator(TestCase):

    def test_sexual_intercourse_age(self):
        options = {
            'sexual_intercouse': YES,
            'sexual_intercourse_age': None}
        form_validator = SexualHistoryAndBehaviourFormValidator(
