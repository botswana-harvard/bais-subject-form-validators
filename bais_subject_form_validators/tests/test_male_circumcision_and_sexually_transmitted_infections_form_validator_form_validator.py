...
from ..form_validations import (
    MaleCircumcissionAndSexuallyTransmittedInfectionsFormValidator)


class TestMaleCircumcissionAndSexuallyTransmittedInfectionsFormValidator(TestCase):

    def test_circumcission_year(self):
        options = {
            'circumcission': YES,
            'circumcission_year': None}
        form_validator = MaleCircumcissionAndSexuallyTransmittedInfectionsFormValidator(
