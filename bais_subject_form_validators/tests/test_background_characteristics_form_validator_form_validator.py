...
from ..form_validations import BackgroundCharacteristicsFormValidator


class TestBackgroundCharacteristicsFormValidator(TestCase):

    def test_respondent_employment_other1(self):
        options = {
            'respondent_employment': OTHER,
            'respondent_employment_other': None}
        form_validator = BackgroundCharacteristicsFormValidator(
