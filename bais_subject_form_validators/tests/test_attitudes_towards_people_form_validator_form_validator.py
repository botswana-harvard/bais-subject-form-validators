...
from ..form_validations import AttitudesTowardsPeopleFormValidator


class TestAttitudesTowardsPeopleFormValidator(TestCase):

    def test_aids_hiv_test_reason_other1(self):
        options = {
            'aids_hiv_test_reason': OTHER,
            'aids_hiv_test_reason_other': None}
        form_validator = AttitudesTowardsPeopleFormValidator(
